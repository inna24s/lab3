    ...
    time = now.getHours() + ':' + now.getMinutes() + ':0' + now.getSeconds(),
        ...
        time = now.getHours() + ':0' + now.getMinutes() + ':' + now.getSeconds(),
            date = [now.getDate(),
                now.getMonth(),
                now.getFullYear()].join('.');
    else if(now.getSeconds()<10&&now.getMinutes()<10) time = now.getHours() + ':0' + now.getMinutes() + ':0' + now.getSeconds(),
        date = [now.getDate(),
            now.getMonth(),
            now.getFullYear()].join('.');
    else time = now.getHours() + ':' + now.getMinutes() + ':' + now.getSeconds(),
            date = [now.getDate(),
                now.getMonth(),
                now.getFullYear()].join('.');
...
function displayCanvas(){
    ...
    var canvasSize = 400;
    canvasHTML.width = canvasSize;
    canvasHTML.height = canvasSize;
